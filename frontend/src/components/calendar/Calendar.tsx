...
const Calendar: React.FC = () => {
  ...
  const [events, setEvents] = useState<CalendarEvent[]>([
    ...
    },
    {
      id: "2",
      title: "Meeting",
      start: new Date(new Date().getTime() + 86400000).toISOString().split("T")[0],
      extendedProps: { calendar: "Success" },
    },
    {
      id: "3",
      title: "Workshop",
      start: new Date(new Date().getTime() + 172800000).toISOString().split("T")[0],
      end: new Date(new Date().getTime() + 259200000).toISOString().split("T")[0],
